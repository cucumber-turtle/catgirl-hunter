...
define gui.accent_color = u'#4bccbf'

## The color used for a text button when it is neither selected nor hovered.
define gui.idle_color = u'#636363'

## The small color is used for small text, which needs to be brighter/darker to
## achieve the same effect.
define gui.idle_small_color = u'#4a4a4a'

## The color that is used for buttons and bars that are hovered.
define gui.hover_color = u'#4bccbf'

## The color used for a text button when it is selected but not focused. A
## button is selected if it is the current screen or preference value.
define gui.selected_color = u'#337aa8'

## The color used for a text button when it cannot be selected.
define gui.insensitive_color = u'#c7c7c7'

## Colors used for the portions of bars that are not filled in. These are not
## used directly, but are used when re-generating bar image files.
define gui.muted_color = u'#e0bf66'
define gui.hover_muted_color = u'#fcb76d'
...
define gui.text_font = "fonts/whatever it takes bold.ttf"

## The font used for character names.
define gui.name_text_font = "fonts/whatever it takes bold.ttf"

## The font used for out-of-game text.
define gui.interface_text_font = "fonts/whatever it takes bold.ttf"
...
define gui.name_xalign = 0.4

## The width, height, and borders of the box containing the character's name, or
## None to automatically size it.
define gui.namebox_width = 256
define gui.namebox_height = 74
